...
urlpatterns = [
	...
	url(r'^program_import/', views.program_import, name='program_import'),  
	...
	url(r'^stats/(?P<exercise>[0-9]+)', views.stats, name='stats'),
	url(r'^stats/', views.stats, name='stats'),
	url(r'^all_stats/(?P<exercise>[0-9]+)', views.all_stats, name='all_stats'),
